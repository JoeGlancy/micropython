...
QDEF(MP_QSTR_current_event, (const byte*)"\xbf\x0d" "current_event")
QDEF(MP_QSTR_is_event, (const byte*)"\x2c\x08" "is_event")
QDEF(MP_QSTR_was_event, (const byte*)"\xb3\x09" "was_event")
QDEF(MP_QSTR_get_events, (const byte*)"\x53\x0a" "get_events")
QDEF(MP_QSTR_click, (const byte*)"\xab\x05" "click")
QDEF(MP_QSTR_long_space_click, (const byte*)"\xe1\x0a" "long click")
QDEF(MP_QSTR_hold, (const byte*)"\x8a\x04" "hold")
QDEF(MP_QSTR_double_space_click, (const byte*)"\xde\x0c" "double click")
